create database db_k24_cntt01_view_index;
use db_k24_cntt01_view_index;

create table TestInsert(id int not null primary key, name varchar(50));

insert into TestInsert(id,name) values (1,'Nam');
insert into TestInsert(id,name) values (0,'Bình');

select * from TestInsert;

insert into TestInsert(id,name) values (9,'Cường');
insert into TestInsert(id,name) values (5,'Lan');
insert into TestInsert(id,name) values (7,'Tiến');

select name from TestInsert limit 2 offset 2;

create table TestKeyVarchar(name_id char(10) not null primary key, age int);

insert into TestKeyVarchar(name_id,age) values ('Bich',20);
insert into TestKeyVarchar(name_id,age) values ('An',18);
insert into TestKeyVarchar(name_id,age) values ('Cuc',22);
insert into TestKeyVarchar(name_id,age) values ('Tuan',19);
insert into TestKeyVarchar(name_id,age) values ('Nam',17);

select * from TestKeyVarchar;

select * from TestKeyVarchar limit 2 offset 2;

select age from TestKeyVarchar limit 2 offset 2;
...
create unique index UIDX_isbn on books(isbn);
...
/*
2) Tạo một view có tên view_users_firstname để hiển thị danh sách các người 
dùng có họ “Nguyễn”. View này cần bao gồm các cột: user_id, username, full_name, 
email, created_at.
*/
select * from users;
